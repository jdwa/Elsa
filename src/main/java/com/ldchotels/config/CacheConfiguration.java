...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ldchotels.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ldchotels.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.ldchotels.protel.domain.PmsBuch.class.getName());
